...
function postToLaravel(endpoint, payload, timeout) {
    return axios.post(
...
export function notifyLaravel(endpoint_1) {
    return __awaiter(
        ...
        function* (endpoint, payload = {}) {
            ...
            try {
                yield postToLaravel(endpoint, payload, 10000);
            } catch (e) {}
        },
    );
}
export function notifyLaravelOrThrow(endpoint_1) {
    return __awaiter(
        this,
        arguments,
        void 0,
        function* (endpoint, payload = {}, timeout = 120000) {
            if (endpoint === 'events') {
                broadcastToWindows('native-event', payload);
            }
            yield postToLaravel(endpoint, payload, timeout);
        },
    );
}
export function broadcastToWindows(event, payload) {
    ...
    if (
        (_a = state.activeMenuBar) === null || _a === void 0
            ? void 0
            : _a.window
    ) {
...
export function goToUrl(url, windowId) {
    var _a;
    (_a = state.windows[windowId]) === null || _a === void 0
        ? void 0
        : _a.loadURL(appendWindowIdToUrl(url, windowId));
}
