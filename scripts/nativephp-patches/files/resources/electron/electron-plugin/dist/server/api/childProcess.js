    ...
    try {
        const proc = utilityProcess.fork(
            ...
            cmd,
            {
                ...
                serviceName: alias,
                env: Object.assign(
                    Object.assign(Object.assign({}, process.env), env),
...
function startPhpProcess(settings) {
    ...
    const iniSettings = Object.assign(
        Object.assign(
            Object.assign({}, getDefaultPhpIniSettings()),
            state.phpIni,
        ),
        customIniSettings,
    );
    ...
    if (settings.cmd[0] === 'artisan' && runningSecureBuild()) {
        settings.cmd.unshift(
            join(getAppPath(), 'build', '__nativephp_app_bundle'),
        );
    }
    settings = Object.assign(Object.assign({}, settings), {
        cmd: [state.php, ...iniArgs, ...settings.cmd],
        env: Object.assign(Object.assign({}, settings.env), defaultEnv),
    });
...
function stopProcess(alias) {
    ...
    console.log(
        'Process [' + alias + '] stopping with PID [' + proc.pid + '].',
    );
...
function getProcess(alias) {
    var _a;
    return (_a = state.processes[alias]) === null || _a === void 0
        ? void 0
        : _a.proc;
}
...
function serializeProcess(runtimeProcess) {
    ...
    return Object.assign(
        {
            pid:
                runtimeProcess.pid !== null && runtimeProcess.pid !== void 0
                    ? runtimeProcess.pid
                    : null,
            settings: runtimeProcess.settings,
        },
        runtimeProcess.error ? { error: runtimeProcess.error } : {},
    );
}
function serializeProcesses(processes) {
    return Object.fromEntries(
        Object.entries(processes).map(([alias, runtimeProcess]) => [
            alias,
...
router.post('/restart', (req, res) =>
    __awaiter(void 0, void 0, void 0, function* () {
        ...
        const waitForProcessDeletion = (timeout, retry) =>
            __awaiter(void 0, void 0, void 0, function* () {
