...
function startAPIServer(randomSecret, attempt = 0) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        return new Promise((resolve, reject) => {
            ...
            // get-port only reserves the port momentarily; another process (such
            // as a second app instance) can grab it before listen() binds. Without
            // this handler the EADDRINUSE error is swallowed and PHP is handed a
            // dead API port. Retry on a fresh port instead, and only resolve once a
