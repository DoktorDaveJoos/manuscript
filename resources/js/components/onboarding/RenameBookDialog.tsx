        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center">
            ...
            >
                <div className="flex flex-col gap-2">
                    <h2 className="font-serif text-[32px] leading-10 tracking-[-0.01em] text-ink">Rename book</h2>
                    <p className="text-sm leading-[22px] text-ink-muted">Give your book a new title.</p>
                </div>
