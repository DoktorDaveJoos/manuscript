...
const variantExtras = {
    default: { selectWithIcon: 'pl-9', chevron: 'h-3.5 w-3.5 right-3.5', icon: 'left-3.5 h-4 w-4' },
    compact: { selectWithIcon: 'pl-8', chevron: 'h-3 w-3 right-3', icon: 'left-3 h-3.5 w-3.5' },
    dialog: { selectWithIcon: 'pl-10', chevron: 'h-4 w-4 right-4', icon: 'left-4 h-4 w-4' },
};
