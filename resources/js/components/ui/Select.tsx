...
const selectBase =
    'w-full cursor-pointer appearance-none border border-border-subtle bg-surface-sidebar text-ink transition-colors hover:border-border-strong focus:outline-none focus:ring-1 focus:ring-ink disabled:cursor-not-allowed disabled:opacity-50 dark:border-border';
