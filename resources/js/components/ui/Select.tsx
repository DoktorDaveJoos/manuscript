...
const selectBase =
    'w-full cursor-pointer appearance-none border border-border-subtle bg-surface-sidebar text-ink transition-colors hover:border-border-strong focus:outline-none focus:ring-1 focus:ring-accent disabled:cursor-not-allowed disabled:opacity-50 dark:border-border';
...
const Select = forwardRef<HTMLSelectElement, SelectProps>(
    ({ variant = 'default', icon, className, children, ...props }, ref) => {
        const v = selectVariants[variant];
