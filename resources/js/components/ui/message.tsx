...
function MessageAvatar({ className, ...props }: ComponentProps<'div'>) {
    return (
        <div
            ...
            className={cn(
                'flex size-7 shrink-0 items-center justify-center self-start overflow-hidden rounded-full bg-neutral-bg text-ink',
                className,
            )}
            {...props}
        />
...
function MessageHeader({ className, ...props }: ComponentProps<'div'>) {
    return (
        <div
            ...
            className={cn(
                'flex max-w-full min-w-0 items-center px-3 text-xs font-medium text-ink-muted group-has-data-[variant=ghost]/message:px-0',
                className,
            )}
            {...props}
        />
...
function MessageFooter({ className, ...props }: ComponentProps<'div'>) {
    return (
        <div
            ...
            className={cn(
                'flex max-w-full min-w-0 items-center px-3 text-xs font-medium text-ink-muted group-has-data-[variant=ghost]/message:px-0 group-data-[align=end]/message:justify-end',
                className,
            )}
            {...props}
        />
