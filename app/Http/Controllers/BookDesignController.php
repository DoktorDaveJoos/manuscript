...
class BookDesignController extends Controller
{
    ...
    private function validateTemplate(Request $request, bool $requireBasedOn = true): array
    {
        return $request->validate([
            ...
            'settings.page.custom_width' => ['nullable', 'required_if:settings.page.trim_size,custom', 'numeric', 'min:50', 'max:500'],
            'settings.page.custom_height' => ['nullable', 'required_if:settings.page.trim_size,custom', 'numeric', 'min:50', 'max:500'],
