    ...
    public function share(Request $request): array
    {
        ...
        return [
            ...
            'app_settings' => fn () => [
                ...
                'show_status_bubbles' => AppSetting::get('show_status_bubbles', true),
                'show_word_count' => AppSetting::get('show_word_count', true),
                'compact_word_count' => AppSetting::get('compact_word_count', true),
                'send_error_reports' => AppSetting::get('send_error_reports', false),
                'send_analytics' => AppSetting::get('send_analytics', true),
                'auto_update' => AppSetting::get('auto_update', true),
