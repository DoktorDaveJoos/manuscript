...
- fix(editor): restore typewriter mode caret pinning (49bc2db)
- ignore Claude Code scheduled-task lock files (3a74603)
- feat(ai): harden preparation pipeline and add per-phase retry (e6ff4b2)
- fix(export): force matter sections onto their own pages (55c71ed)
- fix(export): exclude cover from preview and surface export errors (51900d3)
- feat(publish): persistent auto-save status indicator (da0dca3)
- feat(publish): accept PDF cover uploads (58d542d)
- update changelog for v0.4.9 (02cb2f1)
